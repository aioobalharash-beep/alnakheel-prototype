...
import { CheckCircle2, MapPin, ChevronRight, Home, Calendar as CalendarIcon, Instagram, MessageCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="pt-6 border-t border-primary-navy/5 grid grid-cols-2 gap-8">
          <div className="text-left">
            ...
            <p className="font-bold text-primary-navy">Oct 24, 2024</p>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-bold uppercase tracking-widest text-primary-navy/40 mb-1">Duration</p>
            <p className="font-bold text-primary-navy">3 Nights</p>
          </div>
        </div>
      </motion.div>
