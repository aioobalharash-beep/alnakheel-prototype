    ...
    <div className="space-y-12 pb-12">
      ...
      <section className="px-6 mt-8">
        <div className="flex justify-between items-end mb-6">
          <div>
            ...
            <h2 className="font-headline text-3xl font-bold text-primary-navy">{property?.name || 'Al-Nakheel Sanctuary'}</h2>
          </div>
        </div>
      ...
      <section className="px-6 grid grid-cols-2 gap-4">
        <div className="bg-white p-5 rounded-[20px] border border-primary-navy/5 shadow-sm">
          ...
          <p className="font-headline text-lg font-bold">{property?.capacity || 12} Guests</p>
        </div>
        <div className="bg-white p-5 rounded-[20px] border border-primary-navy/5 shadow-sm">
          ...
          <p className="font-headline text-lg font-bold">{property?.area_sqm || 850} m&sup2;</p>
        </div>
      </section>
      ...
      <section className="px-6">
        ...
        <p className="text-primary-navy/60 leading-relaxed text-sm">
          {property?.description || 'Nestled in the heart of the Omani landscape, Al-Nakheel offers an unparalleled blend of modern luxury and heritage-inspired architecture. Every corner of this estate has been curated to provide a seamless flow between indoor relaxation and outdoor majesty.'}
        </p>
        <div className="mt-4 text-sm text-primary-navy/60">
          <span className="font-bold text-secondary-gold">From {property?.nightly_rate || 120} OMR</span> per night
        </div>
